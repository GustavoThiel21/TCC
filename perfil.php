                ...
                <div class="card">
                    <div class="body">
                        <form action="atualizarusuario.php" id="sign_up" method="POST">
                                <div class="form-line">
                                    <input type="hidden" class="form-control" name="codigo1" value=<?php echo $idusuario ?> disabled>
                            ...
                            <button class="btn btn-block btn-lg bg-red orange waves-effect" type="submit">Salvar</button>
                        </form>
                    </div>
                </div>
            </div>
